...
J3_SOURCE_SCRIPT = "scripts/legacy/train_h5_persistent_vq_advisor.py"
...
def _run_j1_graph_target(**context: object) -> None:
    ...
    run_repo_script("scripts/legacy/eval_j_1.py", j1_args)
