...
DEFAULTS = {
    "output_dir": "artifacts/runs/telemetry/raw/ablation/hypercube/m27_coconut_bridi_runtime",
    "run_id": "",
...
def _run_m27_coconut_bridi_runtime_suite(**context: object) -> None:
    ...
    run_repo_script(
        "scripts/m27/run_m27_coconut_bridi_runtime_suite.py",
        [
            ...
            "--max-steps", str(int(cfg.get("max_steps", 0))),
            "--max-prompt-length", str(int(cfg.get("max_prompt_length", 128))),
            "--language-layers", str(int(cfg.get("language_layers", 1))),
            "--language-heads", str(int(cfg.get("language_heads", 2))),
...
with DAG(
    dag_id="lojban_m27_coconut_bridi_runtime",
    description="M27 Coconut-Bridi autoregressive runtime suite.",
    start_date=datetime(2026, 1, 1),
    schedule=None,
    catchup=False,
    max_active_runs=1,
    tags=["lojban", "m-series", "m27", "coconut-bridi-runtime"],
    params={
        ...
        "max_steps": Param(DEFAULTS["max_steps"], type="integer", minimum=0),
        "max_prompt_length": Param(DEFAULTS["max_prompt_length"], type="integer", minimum=1),
        "language_layers": Param(DEFAULTS["language_layers"], type="integer", minimum=1),
        "language_heads": Param(DEFAULTS["language_heads"], type="integer", minimum=1),
    ...
    PythonOperator(
        task_id="run_m27_coconut_bridi_runtime_suite",
        python_callable=_run_m27_coconut_bridi_runtime_suite,
    )
