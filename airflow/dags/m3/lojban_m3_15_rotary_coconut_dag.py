...
DEFAULTS = {
    ...
    "pack_jsonl": "",
    "strict_balance": True,
    "output_dir": "artifacts/runs/telemetry/raw/ablation/hypercube/m3_15_rotary_coconut",
    "local_files_only": False,
    "run_id": "",
}


def _run_m3_15(**context: object) -> None:
    ...
    run_repo_script("scripts/run_m3_15_rotary_coconut.py", args)


with DAG(
    dag_id="lojban_m3_15_rotary_coconut",
    description="M3.15 Rotary Coconut with structural alignment, decision-margin objective, and promotion gates.",
    start_date=datetime(2026, 1, 1),
    schedule=None,
    catchup=False,
    max_active_runs=1,
    tags=["lojban", "m-series", "m3-15", "rotary", "coconut", "ablation"],
    params={
        ...
        "output_dir": Param("artifacts/runs/telemetry/raw/ablation/hypercube/m3_15_rotary_coconut", type="string", minLength=1),
        "local_files_only": Param(False, type="boolean"),
        "run_id": Param("", type="string"),
    },
) as dag:
    PythonOperator(
        task_id="run_m3_15_rotary_coconut",
        python_callable=_run_m3_15,
    )
