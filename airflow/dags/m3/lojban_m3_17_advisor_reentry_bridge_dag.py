...
DEFAULTS = {
    ...
    "pack_jsonl": "",
    "strict_balance": True,
    "output_dir": "artifacts/runs/telemetry/raw/ablation/hypercube/m3_17_advisor_reentry_bridge",
    "local_files_only": False,
    "run_id": "",
}


def _run_m3_17(**context: object) -> None:
    ...
    run_repo_script("scripts/run_m3_17_advisor_reentry_bridge.py", args)


with DAG(
    dag_id="lojban_m3_17_advisor_reentry_bridge",
    description="M3.17 advisor re-entry bridge: compress advisor cognition into decoder-native return states before answer continuation.",
    start_date=datetime(2026, 1, 1),
    schedule=None,
    catchup=False,
    max_active_runs=1,
    tags=["lojban", "m-series", "m3-17", "reentry", "bridge", "ablation"],
    params={
        ...
        "output_dir": Param("artifacts/runs/telemetry/raw/ablation/hypercube/m3_17_advisor_reentry_bridge", type="string", minLength=1),
        "local_files_only": Param(False, type="boolean"),
        "run_id": Param("", type="string"),
    },
) as dag:
    PythonOperator(
        task_id="run_m3_17_advisor_reentry_bridge",
        python_callable=_run_m3_17,
    )
