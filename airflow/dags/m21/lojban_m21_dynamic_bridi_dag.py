...
DEFAULTS = {
    "seed_list": "23,29",
    "cell_list": "A,B,C,D,E,F,G,H,I,J,K,L,M,N,O",
    "train_size": 6000,
    "eval_size": 1500,
    "epochs": 16,
    "batch_size": 128,
    ...
    "adversarial_train_fraction": 0.0,
...
def _run_m21_dynamic_bridi(**context: object) -> None:
    ...
    args = [
        ...
        "--cell-list",
        str(cfg.get("cell_list", "A,B,C,D,E,F,G,H,I,J,K,L,M,N,O")),
        "--train-size",
        ...
        str(float(cfg.get("adversarial_train_fraction", 0.0))),
        "--adversarial-train-surfaces",
        str(cfg.get("adversarial_train_surfaces", "heldout_paraphrase,clausal_permutation")),
        "--stable-threshold",
...
with DAG(
    ...
    params={
        ...
        "cell_list": Param("A,B,C,D,E,F,G,H,I,J,K,L,M,N,O", type="string", minLength=1),
        ...
        "adversarial_train_fraction": Param(0.0, type="number", minimum=0.0),
        "adversarial_train_surfaces": Param("heldout_paraphrase,clausal_permutation", type="string"),
