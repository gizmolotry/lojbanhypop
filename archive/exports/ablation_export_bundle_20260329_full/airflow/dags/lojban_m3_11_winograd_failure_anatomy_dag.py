...
DEFAULTS = {
    ...
    "relation_vocab": 5,
    "var_min_id": 5,
    "output_dir": "artifacts/runs/telemetry/raw/ablation/hypercube/m3_11_winograd_failure_anatomy",
    "local_files_only": False,
    "run_id": "",
}


def _run_m3_11(**context: object) -> None:
    ...
    args = [
        ...
        str(int(cfg.get("dataset_size_per_bucket", 60))),
        "--buckets",
    ...
    run_repo_script("scripts/run_m3_11_winograd_failure_anatomy.py", args)


with DAG(
    dag_id="lojban_m3_11_winograd_failure_anatomy",
    description="M3.11 Winograd failure anatomy: slice audit, taxonomy, structural comparison, controlled variants.",
    start_date=datetime(2026, 1, 1),
    schedule=None,
    catchup=False,
    max_active_runs=1,
    tags=["lojban", "m-series", "m3-11", "winograd", "probe", "eval"],
    params={
        ...
        "dataset_size_per_bucket": Param(60, type="integer", minimum=1),
        ...
        "output_dir": Param("artifacts/runs/telemetry/raw/ablation/hypercube/m3_11_winograd_failure_anatomy", type="string", minLength=1),
        "local_files_only": Param(False, type="boolean"),
        "run_id": Param("", type="string"),
    },
) as dag:
    PythonOperator(
        task_id="run_m3_11_winograd_failure_anatomy",
        python_callable=_run_m3_11,
    )
