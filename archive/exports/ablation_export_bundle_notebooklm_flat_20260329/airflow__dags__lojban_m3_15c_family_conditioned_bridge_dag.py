...
DEFAULTS = {
    ...
    "pack_jsonl": "",
    "strict_balance": True,
    "output_dir": "artifacts/runs/telemetry/raw/ablation/hypercube/m3_15c_family_conditioned_bridge",
    "local_files_only": False,
    "run_id": "",
}


def _run_m3_15c(**context: object) -> None:
    ...
    args = [
        ...
        "--family-loss-weight",
        str(float(cfg.get("family_loss_weight", 0.5))),
        ...
        "--relation-bias-scale",
        str(float(cfg.get("relation_bias_scale", 0.15))),
        "--runtime-gate-cap",
    ...
    run_repo_script("scripts/run_m3_15c_family_conditioned_bridge.py", args)


with DAG(
    dag_id="lojban_m3_15c_family_conditioned_bridge",
    description="M3.15c family-conditioned bridge with anti-collapse controls and slice-specific supervision.",
    start_date=datetime(2026, 1, 1),
    schedule=None,
    catchup=False,
    max_active_runs=1,
    tags=["lojban", "m-series", "m3-15c", "family-conditioned", "bridge", "ablation"],
    params={
        ...
        "family_loss_weight": Param(0.5, type="number", minimum=0.0),
        ...
        "relation_bias_scale": Param(0.15, type="number", minimum=0.0),
        ...
        "output_dir": Param("artifacts/runs/telemetry/raw/ablation/hypercube/m3_15c_family_conditioned_bridge", type="string", minLength=1),
        "local_files_only": Param(False, type="boolean"),
        "run_id": Param("", type="string"),
    },
) as dag:
    PythonOperator(
        task_id="run_m3_15c_family_conditioned_bridge",
        python_callable=_run_m3_15c,
    )
