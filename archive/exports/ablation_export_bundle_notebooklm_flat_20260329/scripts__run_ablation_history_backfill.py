...
def main() -> None:
    ...
    _write_csv(run_dir / "ablation_history_rows_all.csv", all_rows)
    _write_csv(run_dir / "ablation_history_rows_artifact_only.csv", artifact_rows)
    _write_csv(run_dir / "ablation_history_rows_runnable_only.csv", runnable_rows)
    _write_ledger_md(run_dir / "ablation_history_ledger.md", manifest)
