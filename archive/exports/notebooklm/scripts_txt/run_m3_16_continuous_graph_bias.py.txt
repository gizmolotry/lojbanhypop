...
def main() -> None:
    ...
    report: dict[str, Any] = build_bridge_report(
        track="M3.16",
        script_path="scripts/run_m3_16_continuous_graph_bias.py",
        args=args,
    ...
    report["series"] = series_metadata("M", "M3.16", "scripts/run_m3_16_continuous_graph_bias.py")
    ...
    report = finalize_bridge_report(report, "M3.16")
    ...
    labels = track_cell_labels("M3.16")
    for c in ("A", "B", "C", "D"):
