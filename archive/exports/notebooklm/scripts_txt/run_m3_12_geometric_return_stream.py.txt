...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--output-root", type=Path, default=Path("artifacts/runs/telemetry/raw/ablation/hypercube/m3_12_geometric_return_stream"))
...
def main() -> None:
    ...
    report_data = {
        ...
        "series": series_metadata("M", "M3.12", "scripts/run_m3_12_geometric_return_stream.py"),
        "track": "M3.12",
