...
M21_DYNAMIC_BRIDI_GRID: list[dict[str, Any]] = [
    ...
    {
        "cell_key": "P",
        "cell_id": m21_cell_id("P"),
        "lock": "adversarial_augmented_judri_gated_bridge",
        "label": "M22 relational-synonym semantic generalization bridge",
        "variant": {
            "trace_weight": 1.25,
            "answer_weight": 1.25,
            "counterfactual_weight": 1.25,
            ...
            "judri_bridge_gate_temperature": 1.0,
            "adversarial_train_fraction": 0.25,
            "adversarial_train_surfaces": "heldout_paraphrase,clausal_permutation,relational_synonym_train",
        },
    },
    {
        "cell_key": "Q",
        "cell_id": m21_cell_id("Q"),
        "lock": "adversarial_augmented_judri_gated_bridge",
        "label": "M22 role-chain semantic generalization bridge",
        "variant": {
            "trace_weight": 1.25,
            "answer_weight": 1.25,
            "counterfactual_weight": 1.25,
            ...
            "judri_bridge_gate_temperature": 1.0,
            "adversarial_train_fraction": 0.25,
            "adversarial_train_surfaces": "heldout_paraphrase,clausal_permutation,role_chain_generalization_train",
        },
    },
    {
        "cell_key": "R",
        "cell_id": m21_cell_id("R"),
        "lock": "adversarial_augmented_judri_gated_bridge",
        "label": "M22 polarity-reframe semantic generalization bridge",
        "variant": {
            "trace_weight": 1.25,
            "answer_weight": 1.25,
            "counterfactual_weight": 1.25,
