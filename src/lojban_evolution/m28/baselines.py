...
def _evaluate_learned_logebonic_trace(
    ...
    *,
    ...
    from lojban_evolution.m27.runtime import evaluate_m27_coconut_bridi_runtime
    ...
    trace_tokens = float(metrics.get("trace_token_count", metrics.get("mean_predicted_emitted_symbols_after_bottleneck", 0.0)) or 0.0)
    ...
    return {
        ...
        "zero_trace_accuracy": float(metrics.get("zero_trace_accuracy", 0.0) or 0.0),
        "trace_causality_delta": float(metrics.get("predicted_vs_zero_delta", 0.0) or 0.0),
    }
