...
def main() -> None:
    ...
    cells = {
        "A": "control from de-collapsed bridge base",
        "B": "direct-drive gradient scalpel",
        "C": "late-stage causal blindfold",
        "D": "topological candidate pointer head",
    }
    report: dict[str, Any] = {
        "timestamp": datetime.now(timezone.utc).isoformat(),
        "series": series_metadata("M", "M3.15d", "scripts/run_m3_15d_answer_path_forcing.py"),
        "track": "M3.15d",
