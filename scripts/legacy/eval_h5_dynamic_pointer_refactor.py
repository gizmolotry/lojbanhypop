...
# Ensure sibling legacy modules and repo src are importable when run directly.
...
from train_h5_slice2_bridge import AdvisorArityHead as PointerAdvisorArityHead
