        ...
        for source in (headline, aggregate, top, payload):
            ...
            _merge_existing_metrics(
                ...
                source,
                {
                    ...
                    "m25_strict_delta_vs_matched_prompt": (
                        "m25_strict_delta_vs_matched_prompt",
                        "mean_m25_strict_delta_vs_matched_prompt",
                    ),
                    ...
                    "matched_prompt_to_loose_symbol_ratio": (
                        "matched_prompt_to_loose_symbol_ratio",
                        "mean_matched_prompt_to_loose_symbol_ratio",
                    ),
                    "token_reduction_ratio": ("token_reduction_ratio", "mean_token_reduction_ratio"),
                    "matched_prompt_token_reduction_ratio": (
                        "matched_prompt_token_reduction_ratio",
                        "mean_matched_prompt_token_reduction_ratio",
                    ),
                    ...
                    "m25_accuracy_per_symbol_delta_vs_matched_prompt": (
                        "m25_accuracy_per_symbol_delta_vs_matched_prompt",
                        "mean_m25_accuracy_per_symbol_delta_vs_matched_prompt",
                    ),
                    "matched_prompt_token_budget": ("matched_prompt_token_budget", "mean_matched_prompt_token_budget"),
                    "mean_matched_prompt_tokens": ("mean_matched_prompt_tokens", "mean_mean_matched_prompt_tokens"),
                    "m25_gate_beats_matched_prompt": ("m25_gate_beats_matched_prompt", "mean_m25_gate_beats_matched_prompt"),
