...
- run_id: `m22_oodfix_whole_grid_20260523`
- generated: `2026-05-23T12:05:57.059227+00:00`
- history manifest: `artifacts/runs/telemetry/raw/ablation/hypercube/ablation_history_backfill/m22_oodfix_history_20260523/ablation_history_manifest.json`
- program spine manifest: `artifacts/runs/telemetry/raw/ablation/hypercube/ablation_program_spine/m22_oodfix_spine_20260523/ablation_program_spine_manifest.json`
...
| `M1` | `artifact_anchor` | `e=5 r=5 a=0 d=0` | `runs/j_series/test_run_true_coconut_f23b04e91cce41a199ec99099c6fe223/20260522_194057/run_h_series.json` |  |
...
| `M22` | `artifact_anchor` | `e=1 r=1 a=0 d=0` | `artifacts/runs/telemetry/raw/ablation/hypercube/direct_unified_eval/m22_blended_s_96e_confirm2_oodfix_direct_20260523/direct_unified_eval_manifest.json` | m22_promotion_candidate=1.0000, m22_promotion_gate_pass_rate=1.0000, strict_accuracy=0.8467, m22_candidate_cell_count=1.0000 |
| `Control Plane` | `control_plane_manifest` | `e=0 r=1 a=0 d=0` | `artifacts/runs/telemetry/raw/ablation/hypercube/ablation_history_backfill/m22_oodfix_history_20260523/ablation_history_manifest.json` |  |
