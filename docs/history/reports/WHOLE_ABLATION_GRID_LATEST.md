...
- run_id: `m21_judri_gate_whole_grid_20260517`
- generated: `2026-05-17T23:08:46.305941+00:00`
- history manifest: `artifacts/runs/telemetry/raw/ablation/hypercube/ablation_history_backfill/m21_judri_gate_history_20260517/ablation_history_manifest.json`
- program spine manifest: `artifacts/runs/telemetry/raw/ablation/hypercube/ablation_program_spine/m21_judri_gate_spine_20260517/ablation_program_spine_manifest.json`
...
| `M1` | `artifact_anchor` | `e=5 r=5 a=0 d=0` | `runs/j_series/test_run_true_coconut_5e3adf4ff0124c79a453b221e95e1488/20260517_191830/run_h_series.json` |  |
...
| `M21` | `artifact_anchor` | `e=8 r=8 a=0 d=0` | `artifacts/runs/telemetry/raw/ablation/hypercube/direct_unified_eval/m21_judri_gate_direct_48e_20260517/direct_unified_eval_manifest.json` | strict_accuracy=0.8486, bridi_trace_exact_accuracy=1.0000, gismu_accuracy=1.0000, cmavo_accuracy=1.0000 |
| `Control Plane` | `control_plane_manifest` | `e=0 r=1 a=0 d=0` | `artifacts/runs/telemetry/raw/ablation/hypercube/ablation_history_backfill/m21_judri_gate_history_20260517/ablation_history_manifest.json` |  |
